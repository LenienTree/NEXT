    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center max-w-7xl mx-auto mt-8 sm:mt-12 md:mt-16">  
          <div className='flex flex-col sm:flex-row items-center sm:items-start justify-center text-center sm:text-left mb-2 sm:mb-2 md:mb-2'>
            <p className='text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white font-semibold font-Urbanist mb-2 sm:mb-0'>
              Professional event linking
            {/* </p>
            <p className='text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl sm:pl-3 sm:pt-0 md:pt-3 font-Urbanist text-[#A1A1A1]'> */}
               
            </p>
          </div>
          <p className='text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-[#d2cece] '>
              via
            </p>

          <div className='flex flex-col sm:flex-row items-center justify-center text-center sm:text-left mb-8 sm:mb-12 md:mb-16'>
            
            <div className="text-7xl sm:text-xl md:text-xl lg:text-6xl xl:text-7xl">
              <GradientTextAnimation text="Lenient Tree" />
            </div>
          </div>

          <div className="text-center max-w-2xl mx-auto px-4">
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-[#ffffff] c font-Urbanist leading-relaxed">
