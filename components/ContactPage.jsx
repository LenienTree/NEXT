          ...
          <form className="space-y-8"> {/* Increased vertical spacing between form elements */}
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full py-2 bg-gray-800 border-b border-gray-600 focus:border-green-500 focus:outline-none text-green-400 placeholder-green-200" // Adjusted styling
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                placeholder="Message"
                className="mt-1 block w-full py-2 bg-gray-800 border-b border-gray-600 focus:border-green-500 focus:outline-none text-green-400 placeholder-green-200 resize-none" // Adjusted styling, added resize-none
              ></textarea>
            </div>
            <button
              type="submit"
